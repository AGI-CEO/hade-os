...
import { generateRentPaymentsForLease } from "@/lib/rent-payments";
...
export async function PUT(
  ...
  try {
    ...
    // If the lease is being activated, generate the rent payment schedule.
    if (body.status === "active" && currentLease?.status !== "active") {
      await generateRentPaymentsForLease(lease.id);
    }
